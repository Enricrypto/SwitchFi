    ...
    <footer className="bg-transparent border-t border-white/10 ">
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm/6 text-balance text-gray-400">
              Empowering decentralized finance with fast, secure, and user-friendly DeFi tools for everyone.
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-sm/6 text-gray-400">&copy; 2024 SwitchFi, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
